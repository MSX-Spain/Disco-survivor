...
;Definition sprite 12, name: Sprite-4
	db 0,0,0,3,3,7,7,5
	db 7,7,19,15,3,3,2,2
	db 0,0,0,192,192,224,224,160
	db 224,96,200,240,192,192,64,64
...
;Definition sprite 14, name: Sprite-4
	db 0,0,0,3,3,7,7,5
	db 7,6,19,15,3,3,2,2
	db 0,0,0,192,192,224,224,160
	db 224,224,200,240,192,192,64,64
;Definition sprite 15, name: Sprite-4
	db 0,0,0,3,3,7,7,5
	db 7,6,3,7,7,11,2,6
	db 0,0,0,192,192,224,224,160
	db 224,224,192,224,224,208,64,192
